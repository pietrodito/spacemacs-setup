...
before packages are loaded."
 ;; To edit .spacemacs without to be prompted each time
  ...
  (custom-set-variables
   '(org-babel-load-languages (quote ((emacs-lisp . t) (R . t) (latex .t))))
